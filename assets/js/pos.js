                            ...
                            $.each(response.data,function(key,value){
                                ...
                                .append(
                                    $("<article>")
                                        ...
                                        .append(
                                            // $("<span>")
                                            //     .addClass("badge badge-pill badge-primary float-left")
                                            //     .text("Sale"),
                                            $("<div>")
                                                .addClass("card__img")
                                                .append(
                                                    $("<img>")
                                                        .attr({
                                                            src:'https://i.postimg.cc/8PkwdTYd/image.png'
                                                        })
                                                ),
                                            // $("<div>")
                                            //     .addClass("card__name")
                                            //     .append(
                                            //         $("<p>").text(value.menuName)
                                            //     ),
                                            $("<div>")
                                                .addClass("")
                                                .append(
                                                    $("<span>")
                                                    .addClass("card__preci card__preci--before text-center")
                                                    .text(value.menuName),
                                                    // $("<div>")
                                                    //     .addClass("row")
                                                    //     .append(
                                                    ...
                                                    //                             <div class="product-name">${value.menuName}</div>
                                        ...
                                        .click(function(){
                                            (async () => {
                                                ...
                                                if (quantity) {
                                                    ...
                                                    subtotal += parseFloat(value.price) * quantity;
                                                    ...
                                                    .append(
                                                        $("<tr>")
                                                            .append(
                                                                $("<td>")
                                                                    .text(`${value.menuName} (${value.menuType})`),
                                                                $("<td>")
                                                                    .append(
                                                                        $("<span>")
                                                                        .text(value.price),
                                                                ...
                                                                .append(
                                                                    $("<span>")
                                                                    .text(parseFloat(value.price) * parseFloat(quantity)),
                                                                ),
                                                                $("<td>")
                                                                    ...
                                                                    .append(
                                                                        ...
                                                                        .attr({'title':`Update ${value.menuName}`})
                                                                        .css({'cursor':'pointer',})
                                                                        .append(
                                                                        ...
                                                                        .click(function(){
                                                                            ...
                                                                            var data = objectMenu[value.menuId];
                                                                            $this = $(this);
                                                                            
                                                                            (async () => {
                                                                                const { value: quantity } = await Swal.fire({
                                                                                    title: `Update Cart ${value.menuName}`,
                                                                                    input: "text",
                                                                                    inputLabel: "Quantity",
                                                                        ...
                                                                        .click(function(){
                                                                            ...
                                                                            Swal.fire({
                                                                                ...
                                                                                if (result.value) {
                                                                                    ...
                                                                                    let total = objectMenu[value.menuId].price * objectMenu[value.menuId].quantity;
                                                                                   
                                                                                    if(objectMenu[value.menuId].total_price > total){
                                                                                        objectMenu[value.menuId].total_price = parseFloat(objectMenu[value.menuId].total_price) - total
                                                                                    }else{
